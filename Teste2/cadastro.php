<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = $db->prepare("INSERT INTO `dadosclientes`(`nome`, `email`, `cpf`,`telefone`)
		...
		<div class="table-wrapper">
           ...
           <form method="post">
                    ...
                    <div class="form-group">
						...
						<input required type="text"  class="form-control"  name="cpf" placeholder="CPF" >
                    </div>
                    <div class="form-group">
